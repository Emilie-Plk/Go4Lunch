...
import com.emplk.go4lunch.data.workmate.WorkmateRepositoryFirestore;
...
public abstract class RepositoryModule {
    ...
    @Binds
    public abstract WorkmateRepository bindsWorkmateRepository(WorkmateRepositoryFirestore workmateRepositoryFirestore);
}
